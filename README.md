...
$lote  = $arquivo->addLote(array('tipo_servico'=> 1)); // tipo_servico  = 1 para cobranÁa registrada, 2 para sem registro

$lote->inserirDetalhe(array(
	'codigo_ocorrencia' => 1, //1 = Entrada de tÌtulo, para outras opÁoes ver nota explicativa C004 manual Cnab_SIGCB na pasta docs
	...
	'protestar'        => 2, // 1 = Protestar com (Prazo) dias, 2 = Devolver apÛs (Prazo) dias
	'nome_pagador'      => "JOS… da SILVA ALVES", // O Pagador È o cliente, preste atenÁ„o nos campos abaixo
	...
	'cep_pagador'        => '12345-123', // com hÌfem
	...
	'prazo'              => 5, // prazo de dias para o cliente pagar apÛs o vencimento
